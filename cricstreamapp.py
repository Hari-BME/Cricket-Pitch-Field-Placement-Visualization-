...
def draw_cricket_pitch(ax, fielder_color, stump_color, bat_color, outfield_color, inner_circle_color):
    ...
    inner_circle = patches.Ellipse((0.5, 0.5), 0.6, 0.5, edgecolor='white', facecolor=inner_circle_color, fill=True, ls='-.', zorder=1)
...
def main():
    ...
    # Add input widgets for color selection
    fielder_color = st.color_picker("Select Fielder Color", "#1f77b4")
    stump_color = st.color_picker("Select Stump Color", "#ff0000")
    bat_color = st.color_picker("Select Bat Color", "#8b4513")
    outfield_color = st.color_picker("Select Outfield Color", "#006400")
    inner_circle_color = st.color_picker("Select Inner Circle Color", "#008000")  # Add color widget for inner circle

    # Call draw_cricket_pitch with the existing axis
    draw_cricket_pitch(ax, fielder_color, stump_color, bat_color, outfield_color, inner_circle_color)
